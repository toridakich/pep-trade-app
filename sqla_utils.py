...
ENGINE = create_engine('mysql+pymysql://PEPTradeAPP:DeJesus18Carlton32@localhost/retrosheet', echo=False)
PLAYOFF_ENGINE = create_engine('mysql+pymysql://PEPTradeAPP:DeJesus18Carlton32@localhost/playoffs', echo=False)
